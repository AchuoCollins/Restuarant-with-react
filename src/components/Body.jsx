  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100">
      ...
      <nav className="flex justify-between items-center px-8 py-6">
        <div className="text-2xl font-bold text-green-800">HealthyBites</div>
        <div className="hidden md:flex space-x-8">
          <a href="#" className="text-green-800 hover:text-green-600 font-medium">Home</a>
          <a href="#" className="text-green-800 hover:text-green-600 font-medium">About us</a>
          <a href="#" className="text-green-800 hover:text-green-600 font-medium">Testimonial</a>
          <a href="#" className="text-green-800 hover:text-green-600 font-medium">Team</a>
          <a href="#" className="text-green-800 hover:text-green-600 font-medium">Menu</a>
        </div>
      ...
      <div className="container mx-auto px-4 py-12 md:py-24 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative">
            <div className="w-80 h-80 bg-green-200 rounded-full overflow-hidden shadow-lg">
              <img 
                src="" 
                alt="Healthy food" 
